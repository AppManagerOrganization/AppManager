  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/dev/appversionadd" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6 col-md-offset-3">
              ...
              <button type="button" class="btn btn-primary" id="back">返回</button>
            	 <script type="text/javascript">
              	...
              	function getPath(){
              		 document.getElementById("hid_logoPicPath").value  = document.getElementById("a_downloadLink").value;
